  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="home"></span> หน้าหลัก</a>
        <a href="add_expense.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> บันทึกค่าใช้จ่าย</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <h3 class="mt-4">รายงานการใช้จ่าย</h3>
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">ค่าใช้จ่ายรายปี</h5>
              </div>
              <div class="card-body">
          ...
          <div class="col-md">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title text-center">ประเภทค่าใช้จ่าย</h5>
              </div>
              <div class="card-body">
